    ...
    <div class="container pt-10 md:pt-18 px-6 mx-auto flex flex-wrap flex-col md:flex-row items-center bg-yellow-50">
        ...
        <div class="flex flex-col w-full xl:w-2/5 justify-center lg:items-start overflow-y-hidden ">
            ...
            <div class="flex w-full justify-center md:justify-start pb-24 lg:pb-0 fade-in ">
                {{-- ボタン設定 --}}
                <a href="{{route('contact.create')}}"><button class="mr-4 bg-gray-600 font-bold text-base">お問い合わせ</button></a>
                {{-- ボタンを試しに追加 --}}
                <button class="mr-4 bg-gray-600 font-bold text-base">ご登録はこちら</button>
            </div>
        </div>
        {{-- 右側 --}}
        <div class="w-full xl:w-3/5 py-6 overflow-y-hidden">
            <img class="w-5/6 mx-auto lg:mr-0 slide-in-bottom rounded-lg shadow-xl" src="{{asset('logo/inko_green.png')}}">
        </div>
    </div>
